...
class MemoryActivity : AppCompatActivity() {
    ...
    //Array for images
    private var cardsArray = arrayOf(101, 102, 103, 104, 105, 106, 201, 202, 203, 204, 205, 206)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //shuffle the images!!
        mutableListOf(*cardsArray).shuffle()
    ...
    private fun calculate() {
        ...
        if (firstCard == secondCard) {
            ...
            attemptPoints++
            tvp1.text = "Attempt: $attemptPoints"
        ...
        if (iv11.visibility == View.INVISIBLE &&
            ...
            alertDialogBuilder
                ...
                .setPositiveButton("RESTART") { _, _ ->
                    val intent = Intent(this, this@MemoryActivity::class.java)
                    startActivity(intent)
                    finish()
                }
